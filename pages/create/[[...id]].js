...
const ProductsManager = () => {
    ...
    const{ title, price, inStock, description, content, category, size_s, size_m, size_l} = product
    ...
    const handleSubmit = async(e) => {
        ...
        if(!title || !price || !inStock || !description || !content || category === 'all' || images.length === 0 || !size_s || !size_m || !size_l)
        ...
        <div className="products_manager">
            ...
            <form className="row" onSubmit={handleSubmit}>
                <div className="col-md-6">
                    ...
                    <label htmlFor="inStock">Choose Size</label>
                    <div className="input-group-prepend px-0 my-2">
                        <select name='size_s' id='size_s' value={size_s}
                    ...
                    <div className="input-group-prepend px-0 my-2">
                        <select name='size_m' id='size_m' value={size_m}
                        onChange={handleChangeInput} className="custom-select text-capitalize">
                            <option value="none">None</option>
                            {
                    ...
                    <div className="input-group-prepend px-0 my-2">
                        <select name='size_l' id='size_l' value={size_l}
                        onChange={handleChangeInput} className="custom-select text-capitalize">
                            <option value="none">None</option>
                            {
