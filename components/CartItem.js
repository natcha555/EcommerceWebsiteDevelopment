    ...
    return (
       <tr>
        ...
        <td style={{minWidth:"200px"}} className="w-50 align-middle">
            ...
            <h6 className="mb-1 text-danger">Size: {item.size}</h6>
            <h6 className="text-danger">{item.quantity * item.price}฿</h6>
            {
                item.inStock > 0
                ? <p className="mb-1 text-danger"></p>
                : <p className="mb-1 text-danger">Out Stock{item.inStock}</p>
            }
        </td>
        ...
        <td className="align-middle" style={{minWidth:"50px", cursor:"pointer"}}>
            ...
            style={{fontSiza:'18px'}} data-toggle="modal" data-target="#exampleModal"
            onClick={() => dispatch({
                type: "ADD_MODAL",
